...
<div class="col-12">
    ...
    <div class="row">
        <img src="/img/gendo.jpeg" class="img-fluid offset-2 col-8">
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-4">
        <h2>極秘</h2>
        <p>Maecenas luctus dignissim magna, vitae iaculis lorem ultricies eu. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas scelerisque lectus porttitor tellus scelerisque, vel placera</p>
